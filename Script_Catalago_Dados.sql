...
-- Query para listar todas as tabelas do Banco, o esquema que pertence, quantidade de linhas, tamanho em MB, espaço usado
-- Em MB e Espaço não Utilizado em MB
SELECT TOP 100
    s.[name] AS [schema],
...
-- Query para Listar todos os Index do banco de dados, o esquema e tabela que pertence e o tipo de index que é
-- E mais a quantida de linhas, tamanho em MB, espaço usado em MB e Espaço não Utilizado em MB
SELECT TOP(100)
    s.[name] AS [schema],
    t.[name] AS [table_name],
