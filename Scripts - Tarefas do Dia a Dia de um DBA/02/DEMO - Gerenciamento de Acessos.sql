-- ### ANOTACOES
Segurança em Nivel de Servidor, Database e Objeto
Servidor - Login de Windows ou SQL Server

Permissão de GRANT EXEC - Permite uma procedure executar um UPDATE / DELETE / SELECT etc...
